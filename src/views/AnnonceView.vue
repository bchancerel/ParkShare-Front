      ...
      <div class="col-6 overflow-auto px-3">
        ...
        <form @submit.prevent="submitReservation" class="row g-3">
            <div class="col-md-6">
                ...
                <input type="date" class="form-control" id="startDate" v-model="reservation.startDate" required>
            </div>
            <div class="col-md-6">
                <label for="startTime" class="form-label">Heure de début</label>
                <input type="time" class="form-control" id="startTime" v-model="reservation.startTime" required>
            </div>
            <div class="col-md-6">
                <label for="endDate" class="form-label">Date de fin</label>
                <input type="date" class="form-control" id="endDate" v-model="reservation.endDate" required>
            </div>
            <div class="col-md-6">
